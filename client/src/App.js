...
import { Fab, Button, Card, CardContent, Typography } from "@material-ui/core";
...
function AppButton(props) {
  if (props.enabled) {
    if (props.main) {
      return (
        <Fab color="primary" variant="contained" onClick={props.onClick}>
          {props.value}
        </Fab>
      );
    } else {
        ...
        <Card className="bloh">
          <CardContent>
            ...
            <Typography variant="body2" component="p">
              When you press 'Start' you will hear a chord. Try to play or sing
              the individual notes as requested. A new chord will be played on
              success or after a timeout.
            </Typography>
          </CardContent>
        </Card>
      </div>
